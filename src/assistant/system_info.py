...
class SystemInfo:
    ...
    def load_cheat_sheet(self):
        if self.cheat_sheet_path.exists():
            ...
            return self.create_initial_cheat_sheet()
    ...
    def create_initial_cheat_sheet(self):
        initial_cheat_sheet = {
            "os": platform.system(),
        ...
        self.save_cheat_sheet(initial_cheat_sheet)
        return initial_cheat_sheet

    def save_cheat_sheet(self, cheat_sheet):
        with open(self.cheat_sheet_path, 'w') as f:
